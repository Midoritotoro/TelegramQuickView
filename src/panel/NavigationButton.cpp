...
NavigationButton::NavigationButton(const QString& _text, QWidget* _parent)
    : QAbstractButton(_parent)
    , hoverControl_(QStyle::SC_None)
    , buttonStyle_(Qt::ToolButtonIconOnly)
...
void NavigationButton::setIconSize(const QSize& _iconSize)
{
...
void NavigationButton::setText(const QString& _text)
{
    if (text() == _text)
        return;
...
void NavigationButton::setBadgeValue(const QVariant& _value)
{
...
QVariant NavigationButton::badgeValue() const
{
    return badgeValue_;
}

void NavigationButton::setButtonStyle(Qt::ToolButtonStyle _style)
{
...
Qt::ToolButtonStyle NavigationButton::buttonStyle() const
{
    return buttonStyle_;
}

void NavigationButton::setPopupMode(NavigationButton::PopupMode _mode)
{
    if (popupMode_ == _mode)
        return;
...
NavigationButton::PopupMode NavigationButton::popupMode() const
{
    return popupMode_;
}

void NavigationButton::setAutoRaise(bool _on)
{
    if (autoRaise_ == _on)
        return;
...
bool NavigationButton::autoRaise() const
{
    return autoRaise_;
}

void NavigationButton::setMenu(QMenu* _menu)
{
    if (menu_ == _menu)
        return;
...
QMenu* NavigationButton::menu() const
{
    return menu_;
}
...
QSize NavigationButton::minimumSizeHint() const
{
    return sizeHint();
}

bool NavigationButton::event(QEvent* _event)
{
    switch (_event->type())
    {
...
void NavigationButton::showMenu(QMenu* _menu)
{
    if (!_menu)
        return;
...
void NavigationButton::initStyleOption(QStyleOptionComplex& _option)
{
...
QRect NavigationButton::iconRect() const
{
    const QMargins margins = contentsMargins();
    switch (buttonStyle_)
    {
...
QRect NavigationButton::textRect(const QRect& _iconRect) const
{
    if (buttonStyle_ == Qt::ToolButtonIconOnly)
        return QRect{};
...
QRect NavigationButton::badgeRect(const QRect& _iconRect) const
{
...
QRect NavigationButton::menuButtonRect(const QRect& _iconRect) const
{
...
void NavigationButton::drawBackground(QPainter& _painter, const QStyleOptionComplex& _option, const QRect& _iconRect)
{
...
void NavigationButton::drawMenuButton(QPainter& _painter, const QStyleOptionComplex& _option)
{
...
void NavigationButton::drawBadge(QPainter& _painter, const QStyleOptionComplex& _option)
{
...
void NavigationButton::drawIcon(QPainter& painter, const QIcon& icon, const QStyleOption& option)
{
...
void NavigationButton::drawText(QPainter& painter, const QStyleOptionComplex& option)
{
...
void NavigationButton::updateHoverControl(const QPoint& _pos)
{
