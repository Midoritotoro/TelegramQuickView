	...
	QDialog(parent)
{
    ...
    secondAuthenticationStageGridLayout->addWidget(mobilePhoneCodeLabel, 2, 0, 1, 1, Qt::AlignVCenter | Qt::AlignTop);

    secondAuthenticationStageGridLayout->addWidget(_mobilePhoneCodeLineEdit, 2,1, 1, 1, Qt::AlignCenter);
